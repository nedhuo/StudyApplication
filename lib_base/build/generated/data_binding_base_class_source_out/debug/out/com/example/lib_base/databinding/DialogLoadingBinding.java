...
package com.example.lib_base.databinding;
...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull LinearLayout rootView, @NonNull TextView messageText,
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLoadingBinding((LinearLayout) rootView, messageText, progressBar);
    }
