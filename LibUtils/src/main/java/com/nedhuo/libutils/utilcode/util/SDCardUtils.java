...
public final class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) com.blankj.utilcode.util.Utils.getApp().getSystemService(Context.STORAGE_SERVICE);
    ...
    public static class SDCardInfo {
        ...
        public String toString() {
            return "SDCardInfo {" +
                    ...
                    ", totalSize = " + Formatter.formatFileSize(com.blankj.utilcode.util.Utils.getApp(), totalSize) +
